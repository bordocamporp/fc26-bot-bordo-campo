...
AUCTION_LOG_CHANNEL_ID = os.getenv("AUCTION_LOG_CHANNEL_ID", "1514358694245306559")
ADMIN_ROLE_ID = os.getenv("ADMIN_ROLE_ID", "1498341567105339492")
...
SCAMBI_CHANNEL_ID = "1514358653254107136"
...
SIGNUP_REQUEST_CHANNEL_ID = os.getenv("SIGNUP_REQUEST_CHANNEL_ID", "1514358617682346289")   # RICHIESTE ISCRIZIONI
